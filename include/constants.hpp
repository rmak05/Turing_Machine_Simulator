...
inline constexpr const char *DOT_POS_FILE_PATH          = "../output/tm_pos.dot";
...
inline const sf::Color BG_NEUTRAL_COLOR         = sf::Color(0x99E6FFFF);
inline const sf::Color BG_ACCEPTED_COLOR        = sf::Color(0x8cF569FF);
inline const sf::Color BG_REJECTED_COLOR        = sf::Color(0xF0675DFF);
